...
include dirname(__FILE__) . '/class.crypto.php';
...
class Authenticator {
    ...
    public function getCode($secret,$time = null) {
        ...
        $base32 = new Crypto (5, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567', TRUE, TRUE);
    ...
    public function getUrl($user, $secret) {
        $encoder = "http://chart.apis.google.com/chart?chs=200x200&chld=M|0&cht=qr&chl=";
